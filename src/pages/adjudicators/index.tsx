            ...
            <div className="self-stretch h-full flex-col justify-start items-start gap-24 flex">
              <div className="self-stretch justify-between items-start inline-flex">
                <div className="w-full flex-col justify-start items-start gap-2.5 inline-flex max-w-[60rem]">
                  <div className="self-stretch text-[#ffcf6a] text-7xl font-medium font-['Hikasami']">Lindsay Harpham</div>
                  <p className="self-stretch text-white/70 text-2xl font-medium font-['Hikasami'] whitespace-break-spaces">
                ...
                <img className="w-[45rem] h-[55rem] z-10" src="/adjudicators/2025LindsayHarphamHeadshot.avif" />
              </div>
            </div>
        </div>
    )
