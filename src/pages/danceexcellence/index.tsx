export default function Home() {
    return (
        <div className="w-full h-full flex-col justify-start items-start gap-[8rem] inline-flex px-20 mt-20 mb-20">
            <div className="self-stretch text-white text-9xl font-bold font-['Hikasami'] border-b border-white/30 pb-20">Dance Excellence Award</div>
            <div className="self-stretch h-full flex-col justify-start items-start gap-24 flex">
              ...
              <div className="text-white text-7xl font-medium font-['Hikasami'] border-b border-white/30 pb-20 w-full">Previous Winners</div>
